...
export const UserSettingsBtn: FC = () => (
  <div className="flex items-center justify-center px-5 overflow-hidden font-medium rounded-r-lg select-none md:rounded-lg bg-mirage-600 hover:cursor-pointer hover:bg-mirage-700">
    <img
