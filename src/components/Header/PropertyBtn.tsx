...
export const PropertyBtn: FC<{ isActive?: boolean }> = ({
  isActive = false,
}) => (
  <div className="flex flex-col justify-center h-12 px-2 overflow-hidden group elect-none md:h-full hover:cursor-pointer sm:px-4">
